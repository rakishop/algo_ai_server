...
volume_data = nse.get_volume_gainers()

# Format gainers from most active (positive pChange)
...
# Format losers from most active (negative pChange)  
...
print("✓ Live stock alert sent" if response.json().get('ok') else "✗ Failed")